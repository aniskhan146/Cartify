...
import { LayoutDashboardIcon, PackageIcon, ListOrderedIcon, UsersIcon, BarChart3Icon, SettingsIcon, ShoppingCartIcon, BotIcon, ClipboardIcon, TagIcon } from '../shared/icons';

type AdminPage = 'dashboard' | 'products' | 'categories' | 'variant-options' | 'brands' | 'orders' | 'users' | 'analytics' | 'storefront-settings' | 'ai-assistant' | 'settings';
